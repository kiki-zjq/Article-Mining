<template>
    <div class='dashbord'>
        ...
        <el-row class='cloud-place'>
            <el-col :span='24'>
                <span style='background:#2da8ff;margin-left:-10px'>&nbsp;</span><span style='color:#2da8ff;margin-left:5px'>算法映射</span>

    
                <SelectBar />
                <div class='pie-place' style='text-align:center;padding:20px'>
                    <div class="wrapper" style="width:600px;transform:translate(50%,0%)">
        ...
        <el-row class="analyse-part">
            ...
            <el-col :span='10' class='analyse-right'>
                <span style="background-color:#2da8ff">&nbsp;</span><span style='color:#2da8ff;margin-left:5px'>2015-2019热门算法变化</span>
                <Form />
            </el-col>
